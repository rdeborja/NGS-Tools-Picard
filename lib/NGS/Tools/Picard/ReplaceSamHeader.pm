package NGS::Tools::Picard::ReplaceSamHeader;
use Moose::Role;
...
NGS::Tools::Picard::ReplaceSamHeader

=head1 SYNOPSIS

A Perl Moose role that wraps the ReplaceSamHeader Picard application.

=head1 ATTRIBUTES AND DELEGATES

=head1 SUBROUTINES/METHODS

=head2 $obj->replace_sam_header()

Replace a SAM/BAM files header with one from a standalone header file.

=head3 Arguments:

=over 2

=item * input: name of BAM/SAM file to process (required)

=item * output: Name of output SAM/BAM file after re-heading (optional)

=item * header_file: Name of file containing the SAM/BAM header that will replace the current one (required)

=item * java: Full path to the Java program (default: java)

=item * picard: Full directory path to the Picard suite of tools (default: )

=item * memory: Amount of memory to allocate to the Java engine (default: 8)

=item * createindex: Boolean flag to create a BAM index file (default: true)

=item * tmpdir: Full path to the temp directory (optional)

=back

=cut

sub replace_sam_header {
    my $self = shift;
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc NGS::Tools::Picard::ReplaceSamHeader
...
1; # End of NGS::Tools::Picard::ReplaceSamHeader
