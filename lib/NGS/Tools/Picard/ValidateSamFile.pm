package NGS::Tools::Picard::ValidateSamFile;
use Moose::Role;
...
NGS::Tools::Picard::ValidateSamFile

=head1 SYNOPSIS

A Perl Moose role to wrap Picard's ValidateSamFile.jar program.

=head1 ATTRIBUTES AND DELEGATES

=head1 SUBROUTINES/METHODS

=head2 $obj->ValidateSamFile()
...
=item * input: SAM/BAM file to process
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc NGS::Tools::Picard::ValidateSam
...
1; # End of NGS::Tools::Picard::ValidateSam
